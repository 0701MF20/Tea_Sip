...
public class OrderSummaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String teaName = intent.getStringExtra(com.example.android.teasip.OrderActivity.EXTRA_TEA_NAME);
        int price = intent.getIntExtra(com.example.android.teasip.OrderActivity.EXTRA_TOTAL_PRICE, 0);
        String size = intent.getStringExtra(com.example.android.teasip.OrderActivity.EXTRA_SIZE);
        String milkType = intent.getStringExtra(com.example.android.teasip.OrderActivity.EXTRA_MILK_TYPE);
        String sugarType = intent.getStringExtra(com.example.android.teasip.OrderActivity.EXTRA_SUGAR_TYPE);
        int quantity = intent.getIntExtra(com.example.android.teasip.OrderActivity.EXTRA_QUANTITY, 0);
